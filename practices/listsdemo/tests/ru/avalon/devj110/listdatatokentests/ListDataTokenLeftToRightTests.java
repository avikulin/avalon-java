...
public class ListDataTokenLeftToRightTests {
    public static void main(String[] args) {
        ...
        try {
            ...
            assert ldt.getTailPointer() == -1 : "Pointer of the new token should be -1";
            ...
            ldt.pushLast(0);
            assert ldt.getLength() == 1 : "Wrong length calculation";
            System.out.println("#7 passed");

            assert ldt.getTailPointer() == 0 : String.format("Wrong pointer calculation (%d) on the first append",
                    ldt.getTailPointer());
            ...
            assert ldt.getTailPointer() == -1: "getPointer() return wrong result popping all elements.";
            ...
            assert ldt.getFreeCellsRight()==7:"Error in calculating getFreeCellsRight() after filling the sequence, " +
                                             "which all the elements were removed";
            assert ldt.getFreeCellsLeft()==0:"Error in calculating getFreeCellsLeft() after filling the sequence, " +
                                            "which all the elements were removed";
            ...
            assert ldt.getFreeCellsRight()==10:"Error in calculating getFreeCellsRight() after clearing the " +
                                              "sequence data";
            assert ldt.getFreeCellsLeft()==0:"Error in calculating getFreeCellsLeft() after clearing the sequence data";
